...
该功能将按“双端共用一套核心生成逻辑”的方式实现：网页版提供浏览器内使用体验，桌面版提供 Windows EXE 交付形态。两端共享同一套表单配置模型、字段校验规则、最近一次配置持久化协议、Stata 版本模板管理协议和 Stata 脚本模板生成引擎，避免 Web 与 EXE 版本出现功能分叉。
...
- [ ] **TODO-S5: 实现 Stata 脚本模板生成器**
  - **描述**：根据统一输入模型和 выбранный模板生成脚本正文、说明文本和待补充项提示
  - **涉及模块**：模板生成引擎、输出格式化器
...
- [ ] **TODO-C2: 实现 Web 版配置页面与 ini 导入交互**
...
- [ ] **TODO-C5: 实现 Desktop EXE 宿主与集成页面**
...
- [ ] **TODO-C6: 实现 Desktop 最近配置与用户模板持久化**
